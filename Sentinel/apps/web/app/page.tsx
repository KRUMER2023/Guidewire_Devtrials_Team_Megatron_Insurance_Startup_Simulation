            ...
            <div className="relative z-10 w-full max-w-4xl px-6 py-12 flex flex-col items-center">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Link href="/sentinel/rider" className="group relative flex items-center justify-between p-4 bg-zinc-900/40 hover:bg-zinc-800/60 backdrop-blur-xl border border-zinc-800/50 hover:border-pink-500/30 rounded-2xl transition-all duration-300 shadow-xl hover:shadow-pink-500/5 active:scale-[0.98]">
                        ...
                        <Link href="/sentinel/simulator" className="group relative flex items-center justify-between p-4 bg-zinc-900/40 hover:bg-zinc-800/60 backdrop-blur-xl border border-zinc-800/50 hover:border-pink-500/30 rounded-2xl transition-all duration-300 shadow-xl hover:shadow-pink-500/5 active:scale-[0.98]">
                            <div className="flex items-center gap-4">
                                <div className="bg-pink-500/10 p-3 rounded-xl group-hover:bg-pink-500/20 text-pink-400 transition-colors">
                        ...
                        {/* <Link href="/sentinel/master-dashboard" className="group relative flex items-center justify-between p-4 bg-zinc-900/40 hover:bg-zinc-800/60 backdrop-blur-xl border border-zinc-800/50 hover:border-pink-500/30 rounded-2xl transition-all duration-300 shadow-xl hover:shadow-pink-500/5 active:scale-[0.98]">
                            <div className="flex items-center gap-4">
                                <div className="bg-pink-500/10 p-3 rounded-xl group-hover:bg-pink-500/20 text-pink-400 transition-colors">
