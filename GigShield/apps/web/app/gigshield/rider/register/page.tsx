      ...
      `}</style>
            ...
            <header className="sticky top-0 z-50 flex items-center justify-center h-20 px-6 bg-stone-950/40 backdrop-blur-2xl">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-epilogue font-black text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-pink-600 text-2xl tracking-tighter">GigShield</span>
                </div>
            </header>
                            ...
                            <div className="relative h-48 flex flex-col justify-end p-8 overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h1 className="font-epilogue text-3xl font-extrabold tracking-tight text-on-surface leading-tight">
                                        Register to GigShield using the Zomato's Rider Credential
                                    </h1>
                                </div>
                            </div>
                                    ...
                                    <div className="pt-4">
                                        ...
                                        <div className="mt-8 text-center">
                                            <p className="text-on-surface-variant text-sm">
                                                Already protected by GigShield?
                                                <br></br>
                                                <Link className="text-secondary font-bold hover:text-primary transition-colors ml-1" href="/gigshield/rider/login">Log in here</Link>
                                            </p>
                                        </div>
                                    </div>
                                </form>
            ...
            <footer className="py-10 text-center">
                <p className="text-[10px] text-on-surface-variant font-medium tracking-widest uppercase opacity-40">
                    © 2024 GigShield Technologies. All Rights Reserved.
                </p>
            </footer>
        </>
    );
