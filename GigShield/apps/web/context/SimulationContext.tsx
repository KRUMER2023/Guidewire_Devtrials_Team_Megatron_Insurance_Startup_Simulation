...
const initialState: SimulationState = {
    riders: [
        { id: 'R-1001', name: 'Rahul Sharma', age: 26, zomatoId: 'ZOM-R-1001', vehicleType: 'EV', trustScore: 92, location: [28.6139, 77.2090], status: 'ACTIVE', primaryH3Zone: null },
    ],
    hexagons: {},
    events: [],
...
function simulationReducer(state: SimulationState, action: Action): SimulationState {
    switch (action.type) {
        ...
        case 'FOCUS_LOCATION':
            return { ...state, focusLocation: action.payload.location };
